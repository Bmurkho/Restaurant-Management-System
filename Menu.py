...
billbutton = Button(topFrame, text= "Generate Bill",font=('bold', 20) , command= Generate_bill).grid(row= 10 ,column= 0,padx=10, pady=5)
inventorybutton= Button(topFrame, text= "Inventory",font=('bold', 20) , command= Inventory).grid(row= 11 ,column= 0, padx=10, pady=5)
